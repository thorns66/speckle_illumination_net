function [Xguess] = deconvRLupdate(forwardFUN, backwardFUN, Htf, maxIter, Xguess, inputFileName, savePath)
...
%%%%%%%%%%%%%%%%%% Save the results %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    imwrite( squeeze(XguessSAVE1(:,:,1)), [savePath '35_Recon3D_' inputFileName(1:end-4) '_Iter' num2str(i) '.tif']);
    for kk = 2:size(XguessSAVE1,3),
        imwrite(squeeze(XguessSAVE1(:,:,kk)),  [savePath '35_Recon3D_' inputFileName(1:end-4) '_Iter' num2str(i) '.tif'], 'WriteMode', 'append');
    end
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%ÐÞ¸Ä
    if strcmp( inputFileName(end-3:end), '.tif')
         save([savePath '35_Recon3D_'  inputFileName(1:end-4) '_Iter' num2str(i) '.mat'], 'XguessSAVE1', '-v7.3');
    end
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
end
