...
> **当前正式基线（2026-09-13）：Mean100，Mean-RL3 主重建基础＋E3＋mean≤100%，默认 final800，保留 Set。** P01–P11＋真实45/55混合训练，不含P12。详见 [当前基线记录](CURRENT_BASELINE.md)、[模型及来源清单](CURRENT_BASELINE.json) 和 [跨任务读取规则](AGENTS.md)。下文为2026-09-05历史快照，不覆盖当前注册。
