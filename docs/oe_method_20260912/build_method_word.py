...
SRC = Path('/tmp/oe_method_20260912/oe_principle_and_method_20260912.md')
OUT = Path('/tmp/oe_method_20260912/oe_principle_and_method_20260912.docx')
...
def math_para(parent,idx):
    ...
    if eqtags.get(idx) in {'2','5','6','7','9','10','12','13'}:
...
wr(p,'Optics Express  |  Principle and method  |  12 September 2026')
footer=E.Element('{%s}ftr'%NS['w'],nsmap={'w':NS['w']});p=add(footer,'w:p');props(p,'Running',align='right')
wr(p,'Principle and method  |  ');f=add(p,'w:fldSimple',instr='PAGE');wr(f,'1')
...
Path('/tmp/oe_method_20260912/conversion_report.json').write_text(json.dumps(report,indent=2))
