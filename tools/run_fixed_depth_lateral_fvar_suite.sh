...
mkdir -p "${root}"
run_one 1 f1_var_h2_b0p25_curv001 --mode h2 --bound 0.25 \
  --curvature-gradient-ratio 0.01 &
pid1=$!
run_one 2 f2_var_h2_b0p5_curv003 --mode h2 --bound 0.5 \
  --curvature-gradient-ratio 0.03 &
pid2=$!
run_one 3 f3_var_cov_b0p25_curv001 --mode covariance --bound 0.25 \
  --curvature-gradient-ratio 0.01 &
pid3=$!
run_one 4 f4_var_cov_b0p5_curv003 --mode covariance --bound 0.5 \
  --curvature-gradient-ratio 0.03 &
pid4=$!
run_one 5 f5_var_joint_b0p5_r01_curv003 --mode joint --bound 0.5 \
